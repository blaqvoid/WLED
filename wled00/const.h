...
#define GRADIENT_PALETTE_COUNT 63 //WLEDMM netmindz ar palette +3, ewowi Random Smooth palette +1, BLAQ VOID +1
...
#define USERMOD_ID_BLAQVOID_AR              95  // Usermod "blaqvoid_AR_pallet.h"
